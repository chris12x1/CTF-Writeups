...
## 🏆 Featured: Bloomberg × The Knowledge House CTF 2026 — 🥇 1st Place
...
- **Reverse engineering & static analysis** — `strings`, ELF binaries, obfuscated JS
- **Prompt injection** against LLM-backed features
...
### 🏆 Bloomberg × The Knowledge House CTF 2026 — 1st Place
...
- 📁 Write-up: ➡️ [`picoCTF-2026/`](picoCTF-2026/)

### TryHackMe — AI Odyssey
- AI/LLM security challenge series _(add a one-line summary of what you covered)_  
- 📁 Write-up: ➡️ [`TryHackMe-AIOdyssey/`](TryHackMe-AIOdyssey/)
